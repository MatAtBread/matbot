...
- 987e992: The derived tool dts survives two plugins declaring a same-named local type.
  ...
  compile (`TS2300`) and both references resolved to an _error_ type — which is assignable to anything, so
