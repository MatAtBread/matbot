...
- Ships a `profile` tool (`list` / `create` / `delete`). Its presence is what makes the web UI show its
...
**restart**. On reload the plugin logs a warning and does not register the `profile` tool. (This is a host
